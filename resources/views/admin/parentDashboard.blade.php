    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="overflow-auto modal-body" style="max-height: 80vh;">
                <form id="parentRegistrationForm" method="POST" action="{{ route('parents.register.submit') }}" class="needs-validation" novalidate>
                    @csrf
                    <input type="hidden" id="usertype" name="usertype" value="parent">

                    <div class="form-group">
                        <label for="pFname" class="form-label">First Name:</label>
                        <input type="text" class="form-control rounded-input" id="pFname" name="pFname" placeholder="Enter First Name" required>
                        <div class="invalid-feedback">Please provide a first name.</div>
                    </div>

                    <div class="form-group">
                        <label for="pLname" class="form-label">Last Name:</label>
                        <input type="text" class="form-control rounded-input" id="pLname" name="pLname" placeholder="Enter Last Name" required>
                    ...
                    <div class="form-group">
                        <label for="pAddress" class="form-label">Address:</label>
                        <input type="text" class="form-control rounded-input" id="pAddress" name="pAddress" placeholder="Enter Address" required>
                    ...
                    <div class="form-group">
                        <label for="email" class="form-label">Email:</label>
                        <input type="email" class="form-control rounded-input" id="email" name="email" placeholder="Enter Email" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control rounded-input" id="password" name="password" placeholder="Enter Password" required>
