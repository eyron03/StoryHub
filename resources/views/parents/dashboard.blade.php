    ...
    <div class="p-4 text-black content col-12 col-md-10 col-lg-8">
        ...
        <tr>
            <td style="padding: 20px; color: black;">
                ...
                <p>
                    - <strong>Add Children:</strong> Easily register new children to your account.
                </p>
                <p>
                    - <strong>Manage Children:</strong> Update and oversee your children's profiles to ensure accurate information.
                </p>
                <p>
                    - <strong>View Reports:</strong> Access reports to track your child's academic progress and performance.
                </p>
                <p>
                    Use these features to actively engage in your child's learning journey.
                </p>
            </td>
        </tr>
    </table>
