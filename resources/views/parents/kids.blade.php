...
<div class="container mt-4">
    <div class="row">
        ...
        <br>
        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addChildModal">Add Child</button>
        <br> <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" onclick="confirmDelete('{{ route('children.destroy', $child->id) }}')">Delete</button>
                                </div>
                            </td>
                        </tr>
                    @empty
        ...
        <div class="modal fade" id="addChildModal" tabindex="-1" aria-labelledby="addChildModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="form-group">
                        <label for="childAddress" class="form-label">Address:</label>
                        <input type="text" class="form-control" id="childAddress" name="childAddress" placeholder="Enter Address" required>
                    </div>
                    <div class="form-group">
                        <label for="childGender" class="form-label">Gender:</label>
