...
<head>
    ...
    <style>
        ...
        #portraitVideo {
            width: 100%; /* This will stretch the width to 100% of the container */
            height: 100vh; /* 100% of the viewport height */
            object-fit: cover; /* This will stretch the video content to cover the entire area without preserving aspect ratio */
        }
    
        /* Optional: Adjust for specific breakpoints (mobile, tablet) */
        @media (max-width: 768px) {
            #portraitVideo {
