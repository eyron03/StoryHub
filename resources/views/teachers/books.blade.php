                        ...
                        <div class="col-md-6">
                            <div class="mb-3 input-group">
                                <input type="text" class="form-control" id="searchInput" name="search"
                                    placeholder="Search by Book Title..." value="{{ request()->input('search') }}">
                    ...
                    <div class="row" id="bookList">
                        @foreach ($flipbooks as $fb)
                            <div class="text-center col-6 col-sm-4 col-md-3 col-lg-2 book gif-item">
                                <a href="{{ route('teacher.showbook', $fb->id) }}" style="float: left; clear: both;">
                                    <img class="img-thumbnail" alt="200x200"
                                        style="width: 100%; max-width: 150px; height: 200px;margin-left: 10px;"
                                        src="{{ asset(explode(',', $fb->images)[0]) }}" data-holder-rendered="true">
                                </a>
                                <br><br><br><br><br><br><br><br><br>
                                <span
                                    style="font-size: 13px; font-weight: bold; color: #333;">{{ $fb->book_name }}</span>
                                <p style="font-size: 11px; color: #666;">
                                    <span class="short-desc">{{ Str::limit($fb->desc, 50, '...') }}</span>
                                    <span class="full-desc book-desc"
                                        style="display: none;">{{ $fb->desc }}</span>
